...
public class PhotoDownloadResource {
    ...
    public @ResponseBody ResponseEntity<byte[]> fotos(@PathVariable("countryCode") final String countryCode,
    ...
    public @ResponseBody ResponseEntity<byte[]> photos(@PathVariable("countryCode") final String countryCode,
                                  @PathVariable("filename") final String filename,
                                  @RequestParam("width") final Integer width) throws IOException {
    ...
    private static @ResponseBody ResponseEntity<byte[]> downloadPhoto(final File photo, @RequestParam("width") final Integer width) throws IOException {
    ...
    public @ResponseBody ResponseEntity<byte[]> inbox(@PathVariable("filename") final String filename,
                                 @RequestParam("width") final Integer width) throws IOException {
    ...
    public @ResponseBody ResponseEntity<byte[]> inboxProcessed(@PathVariable("filename") final String filename,
                                          @RequestParam("width") final Integer width) throws IOException {
        LOG.info("Download inbox file={}", filename);
