...
public class BahnhofTest {
    ...
    public void distanceTo() throws Exception {
        assertEquals(53.1, new Bahnhof(0, "", "", new Coordinates(50.554550, 9.683787), null, null).distanceTo(50.196580, 9.189395), 0.1);
    }

    @Test
    public void appliesToNullPhotographer() {
        final Bahnhof bahnhof = new Bahnhof(0, "", "", new Coordinates(0.0, 0.0), null, null);
    ...
    public void appliesToPhotographer() {
        final Bahnhof bahnhof = new Bahnhof(0, "", "", new Coordinates(0.0, 0.0), new Photo(0, "test", "URL", "CC0"));
    ...
    public void appliesToDistance() {
        final Bahnhof bahnhof = new Bahnhof(0, "", "", new Coordinates(50.554550, 9.683787), null, null);
    ...
    public void appliesToDistanceAndPhotographer() {
        final Bahnhof bahnhof = new Bahnhof(0, "", "", new Coordinates(50.554550, 9.683787), new Photo(0, "test", "URL", "CC0"));
